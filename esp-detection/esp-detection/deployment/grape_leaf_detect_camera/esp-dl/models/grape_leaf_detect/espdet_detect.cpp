...
{
    switch (m_model_type) {
    case model_type_t::ESPDET_PICO_224_224_GRAPE_LEAF:
#if CONFIG_FLASH_ESPDET_PICO_224_224_GRAPE_LEAF || CONFIG_GRAPE_LEAF_DETECT_MODEL_IN_SDCARD
        m_model = new espdet_detect::ESPDet("espdet_pico_224_224_grape_leaf.espdl");
#else
        ESP_LOGE("grape_leaf_detect", "espdet_pico_224_224_grape_leaf is not selected in menuconfig.");
#endif
        break;
    }
}
