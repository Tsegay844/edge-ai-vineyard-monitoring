...
if __name__ == "__main__":
    quant_espdet(
        onnx_path="espdet_pico_416_320_grape_leaf.onnx",
        target="esp32s3",
        num_of_bits=8,
        device='cpu',
        batchsz=1,  # Must be 1 for rect models
        imgsz=(320, 416),  # [h, w] format: 320÷32=10, 416÷32=13
        calib_dir="deploy/grape_leaf_calib",
        espdl_model_path="espdet_pico_416_320_grape_leaf.espdl",
    )
