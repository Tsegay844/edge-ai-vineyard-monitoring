...
def Train(pretrained_path=None, dataset="dataset/data.yaml", imgsz=(320, 416), **kwargs):
    """
    ...
    if pretrained_path not in [None, 'None']: # use pretrained weights
        ...
        model = YOLO("yolo11n.pt") # pretrained yolo11n weights   
    ...
    train_setting = dict(
        ...
        name='train',           # Experiment name (creates runs/detect/train/)
    ...
    print(f"Last weights:  runs/detect/train/weights/last.pt")
    print("="*70 + "\n")
